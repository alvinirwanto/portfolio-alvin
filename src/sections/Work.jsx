    ...
    return (
        <section className='text-white-primary px-3 md:px-0 xl:px-[3rem] pt-[20rem] relative' name='work' id='work'>
            ...
            <div className='flex justify-end text-end'>
                <p className='xl:max-w-[10vw] text-blue-primary'>Here are the projects I've developed in my role as a Frontend Web Developer:</p>
            </div>


            <div className="flex flex-col gap-[5rem] mt-[5rem] z-[70]">
                {
                    works.map((work, i) => (
                        <div key={i} className={`grid grid-cols-10 place-items-center ${i % 2 === 0 ? 'text-right' : 'text-left'}`}>

                            <div className={`${i % 2 === 0 ? 'col-start-1 xl:col-start-2 col-end-11 xl:col-end-7' : 'col-start-1 xl:col-start-5 col-end-11 xl:col-end-10'} relative xl:grid-rows-1 xl:row-start-1 bg-white-secondary min-h-[25vh] xl:min-h-[45vh] rounded-lg w-full z-10`}>
                                <Image
                                    height={700}
                                    width={700}
                                    src={work.image}
                            ...
                            <div className={`${i % 2 === 0 ? 'col-start-2 col-end-11 xl:col-start-5 xl:col-end-11 items-end' : 'col-start-1 col-end-10 xl:col-start-1 xl:col-end-7 items-start'} xl:grid-rows-1 xl:row-start-1 flex flex-col gap-2 xl:gap-4 z-20 mt-8 xl:mt-0`}>
                                ...
                                <h3 className='text-xl xl:text-3xl font-semibold max-w-full xl:max-w-[70%]'>{work.title}</h3>
